...
namespace ET
{
	...
	public  class DlgMainViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Button E_ChessButton
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_ChessButton == null )
     			{
		    		this.m_E_ChessButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Chess");
     			}
     			return this.m_E_ChessButton;
     		}
     	}

		public UnityEngine.UI.Image E_ChessImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_ChessImage == null )
     			{
		    		this.m_E_ChessImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Chess");
     			}
     			return this.m_E_ChessImage;
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_ChessButton = null;
			this.m_E_ChessImage = null;
		...
		private UnityEngine.UI.Button m_E_ChessButton = null;
		private UnityEngine.UI.Image m_E_ChessImage = null;
